...
var expressValidator = function(options) {
  ...
  return function(req, res, next) {
    ...
    req.asyncshowError = function(mapped) {
      runContexts();
      return Promise.all(req._asyncshowError).then(() => {
        if (req._showError.length > 0) {
          return Promise.reject(req.showError(mapped, true));
        }
