...
declare namespace ExpressValidator {
  ...
  export interface RequestValidation {
    ...
    showError(mapped?: boolean): Record<string, any> | any[];
    showError<T>(mapped?: boolean): Record<string, T> | T[];
    asyncshowError(mapped?: boolean): Promise<any[] | Record<string, any>>;
    asyncshowError<T>(mapped?: boolean): Promise<T[] | Record<string, T>>;
